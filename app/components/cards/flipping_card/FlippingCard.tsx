...
export const FlippingCard = ({  title = "default title",
                ...
                <div className="card__inner--back">
                    ...
                    <div className="card__inner--back-body"> 
                        ...
                        <div className="card__inner--back-tags-container">
                            ...
                            {tags ? tags.map(tag => <div className="card__inner--back-tag" key={tag}>{tag}</div>) : <div>No tags</div>} 

                        </div>

                    </div> 
                
                    <a className="card__inner--back-cta" href="#" target="_blank" rel="noopener noreferrer">LEARN MORE </a>
