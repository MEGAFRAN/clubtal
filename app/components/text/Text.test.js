...
describe("<Text />", () => {
  ...
  it("Tests that the paragraph element is rendered with the correct text and alignment style when a very long text string is provided", () => {
    const longText =
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod, diam vel bibendum bibendum, velit sapien bibendum sapien, vel bibendum sapien sapien vel sapien."
