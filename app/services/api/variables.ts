...
const GET_SENTIMENT_ANALYSIS_ENDPOINT = "/api/get-sentiment-analysis"
...
export const GET_SENTIMENT_ANALYSIS = `${CLUBTAL_SERVICES_API}${GET_SENTIMENT_ANALYSIS_ENDPOINT}`