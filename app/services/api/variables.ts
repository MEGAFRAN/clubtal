...
const SPECIALIZATION_ORIENTATION_CHAT_BOT_ENDPOINT = "/api/specialization-orientation-chat-bot"
...
const ADD_CMS_USER_EMAIL_ENDPOINT = "/api/add-cms-user-email"
...
export const SPECIALIZATION_ORIENTATION_CHAT_BOT = `${CLUBTAL_SERVICES_API}${SPECIALIZATION_ORIENTATION_CHAT_BOT_ENDPOINT}`
...
export const ADD_CMS_USER_EMAIL = `${CLUBTAL_SERVICES_API}${ADD_CMS_USER_EMAIL_ENDPOINT}`
